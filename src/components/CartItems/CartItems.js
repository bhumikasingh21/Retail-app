    ...
    <React.Fragment>
      ...
      {state.cartData.length > 0 ? (
        ...
        <div className="empty-cart">
          ...
          <p>
                        The price and availability of items at Retail App are
            subject to             change. The shopping cart is a temporary
            place to store a list of             your items and reflects each
            item's most recent price. Do you have a             promotional
            code? We'll ask you to enter your claim code when it's            
            time to pay.          {" "}
          </p>
                   {" "}
          <Link to="/">
